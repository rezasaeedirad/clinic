...
<body dir="rtl">
  ...
  <header class="header">
    ...
    <div class="header-left">
      ...
      <a href="{{ url('/login/patient') }}" class="btn secondary">ورود / ثبت‌نام مراجعه‌کننده</a>
      <a href="{{ url('/login/doctor') }}" class="btn secondary">ورود / ثبت‌نام پزشک</a>
  ...
  <main class="main">
    <div class="search-box">
      <div class="logo-container">
        <img src="{{ asset('images/textlogo.png') }}" alt="لوگوی متنی" class="logo-text">
        <img src="{{ asset('images/logo.png') }}" alt="لوگو" class="logo-icon">
      </div>
